# -*- coding: utf-8 -*-
"""Lazy-loaded Qwen3-VL backend for the Colab T4 inference path."""
...
class Qwen3VLBackend:
    """Frozen Qwen3-VL inference backend; no training or score generation."""
    ...
    @classmethod
    def from_config(cls, config: Mapping[str, object]) -> "Qwen3VLBackend":
        normalized = validate_vlm_config(config)
        try:
            import torch
